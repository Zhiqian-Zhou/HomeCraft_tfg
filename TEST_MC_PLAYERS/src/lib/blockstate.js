...
const FACE_MAP_OVERRIDES = {
  ...
  // Walls y bamboo: el archivo de textura no coincide con el nombre del bloque.
  cobblestone_wall:   { up: 'cobblestone',         down: 'cobblestone',       side: 'cobblestone' },
  stone_brick_wall:   { up: 'stone_bricks',        down: 'stone_bricks',      side: 'stone_bricks' },
  diorite_wall:       { up: 'diorite',             down: 'diorite',           side: 'diorite' },
  bamboo:             { up: 'bamboo_stalk',        down: 'bamboo_stalk',      side: 'bamboo_stalk' },
